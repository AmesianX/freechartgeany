...
// base 10 logarithm
#define qLog10(v) 	((qreal) ((qreal)qLn((qreal)v)/(qreal)2.302585))
...
class QTAChartBarData		// Bar's/Candle's geometry data
{
public:	
...
public:
  // functions
  QTAChartCore (QWidget * parent = 0);		// constructor
  ...
  void addLabel (QGraphicsTextItem *item, qreal x, qreal y); // add label
  ...
  QStringList monthlit; // month literal (JAN, FEB etc)
