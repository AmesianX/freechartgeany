...
{
Q_OBJECT public:
  QTAChartSceneEventFilter (); // constructor
  QTAChartSceneEventFilter (QObject * parent); // constructor
...
{
Q_OBJECT public:
  QTAChartEventFilter (); // constructor
  QTAChartEventFilter (QObject * parent); // constructor
...
{
Q_OBJECT public:
  QTACObjectEventFilter (QObject * parent); // constructor
  QTACObjectEventFilter (); // constructor
