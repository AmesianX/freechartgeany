...
typedef QList < qreal >Coordinate;
...
class SubChartButton : public QToolButton
{
  Q_OBJECT
public:
  SubChartButton (QTACObject *); // constructor
...
// variables
  ...
  int subchart_dec;		     // decrement of nsubcharts. initially 1, 0 if delete later
...
// variables
  ...
  DynParamsDialog *paramDialog; // indicators' parameters dialig
