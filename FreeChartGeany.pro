...
INCLUDEPATH += include 3rdparty/sqlite3/include 3rdparty/ta-lib/include 

QMAKE_CFLAGS_RELEASE += -DSQLITE_MAX_COLUMN=256 -DSQLITE_MAX_SQL_LENGTH=134217728 -DSQLITE_MAX_EXPR_DEPTH=256 -DSQLITE_MAX_COMPOUND_SELECT=128 \  
-DSQLITE_THREADSAFE=1 -DSQLITE_TEMP_STORE=2 -DSQLITE_DEFAULT_PAGE_SIZE=4096
...
unix {
    ...
    target.path = /usr/libexec/freechartgeany
    manual.path = /usr/libexec/freechartgeany
